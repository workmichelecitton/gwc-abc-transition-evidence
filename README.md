...
| 23 sources never read | Registered but carrying no evidence record — mostly the block S086–S100, which extraction never reached. Listed in `prompts/08-unmined-sources.md`. The build warns every run. |
