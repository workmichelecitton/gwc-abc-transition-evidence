window.SITE_DATA = {
 ...
 "findings": [
  ...
  {
   "finding_id": "F015",
   "statement": "Clusters were treated as passive actors in the first pooled fund allocation, and the indicator list issued to partners diverged from the indicators agreed in the sector operational framework.",
   "theme": "ABC",
   "type": "barrier",
   "strength": "medium",
   "n_records": 2,
  ...
  {
   "finding_id": "F364",
   "statement": "The entire counterpart team at the lead ministry left within one year, including the minister, leaving nobody the cluster had previously worked with; meetings to rebuild the relationship were repeatedly cancelled and the transition dialogue stalled.",
   "theme": "Transition",
   "type": "barrier",
   "strength": "high",
   "n_records": 2,
  ...
  {
   "finding_id": "F511",
   "statement": "Many partners making rapid entries into and exits from communities in order to reach the highest-severity municipalities creates a risk of doing harm, which the cluster raised with the donor.",
   "theme": "Transition",
   "type": "barrier",
   "strength": "low",
   "n_records": 1,
  ...
  {
   "finding_id": "F512",
   "statement": "Partners reported nutrition actors distributing powdered milk without complementary water and sanitation activities, which turns a nutrition intervention into a health risk.",
   "theme": "Transition",
   "type": "barrier",
   "strength": "low",
   "n_records": 1,
  ...
  {
   "finding_id": "F521",
   "statement": "Temporary accommodation managed by the national disaster authority prioritises speed of implementation, with little attention to gender or to the needs of children, and shelter and WASH standards are not consistently applied.",
   "theme": "Transition",
   "type": "barrier",
   "strength": "low",
   "n_records": 1,
