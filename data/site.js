window.SITE_DATA = {
 ...
 "records": [
  ...
  },
  {
   ...
   "type": "context",
   "statement": "Where control of territory is divided, area-based platforms were created to carry the clusters' work into every area of control and to connect it to community feedback mechanisms — presented as a way to make a shrinking response go further.",
   "level": "subnational",
   "countries": [
    "SYR"
   ],
