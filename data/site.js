window.SITE_DATA = {
 ...
 "findings": [
  ...
  {
   "finding_id": "F201",
   "statement": "Dedicated structures had to be created — a drought strategic working group, community resource centres — which shows the existing coordination systems could not support integrated multi-sector assistance.",
   "theme": [
    "ABC"
   ],
   "example": "",
   ...
   "unmerged": false,
   "highlight": {
    "headline": "Having to build a new structure says the old one did not fit",
    "plain": "",
    "so_what": "",
    "rank": null
   }
