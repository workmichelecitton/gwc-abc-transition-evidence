...
|---|---|---|---|---|
| `S083` | **51** | 2026 | GWC | GWC NCP Validation Workshop — Day 2: Transition in Humanitarian Settings. Tran |
...
| `S040` | **4** | 2024 | Global Education Cluster | ABC: Responses from Cluster Coordinators |
| `S044` | **4** | 2024 | GWC | Area-Based Coordination Survey |
| `S039` | **3** | 2024 | Global Shelter Cluster | ABC – Findings from consultation with countries |
...
## Block B — published third-party. I can find some; several are behind domains my fetcher cannot read.

**39 sources · 75 records.**

| Source | Records | Year | Organisation | Title |
|---|---|---|---|---|
| `S055` | **7** | 2026 | UNICEF | Humanitarian transition context — Joint EMOPS, CoE and Regional Office support |
...
| `S065` | **3** | 2025 | Kalden & Rymarenko | Ukraine Education Cluster Transition Plan 2025–2026. NOTE: Replaces "Source 23 |
...
| `S069` | **2** | 2013 | UNICEF Evaluation Office | Evaluation of UNICEF CLA Role. NOTE: Pre-2015; restored to active registry — p |
...
- `S019` = the March 2026 IASC cluster simplification note, already in `guidance.csv`.
- `S034` and `S077` = UNDP Area-Based Development Practice Note. **These are the same document counted as two independent sources.**
- `S070` = the GPC/NRC continuity of protection note.
